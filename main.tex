...
\title{Design Constraints for Aircraft Flight Control Laws}
...
Aircraft flight controllers are designed to comply with various safety and performance objectives. The design process often involves adopting traditional aerodynamic model validation, classical control theory, nonlinear controller verification in the high-fidelity model. 
